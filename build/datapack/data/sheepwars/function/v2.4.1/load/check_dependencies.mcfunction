...
#> sheepwars:v2.4.1/load/check_dependencies
#
...
execute if score #dependency_error sheepwars.data matches 0 if score #realistic_explosion.major load.status matches 1 if score #realistic_explosion.minor load.status matches 2 unless score #realistic_explosion.patch load.status matches 1.. run scoreboard players set #dependency_error sheepwars.data 1
