...
# Chercheur
execute if entity @s[tag=sheepwars.chercheur] on passengers run data modify entity @s NoAI set value 0b
...
execute if entity @s[tag=sheepwars.distorsion] run particle dust{color:[0.5,0.0,0.5],scale:1} ~ ~ ~ 2 2 2 0 10
