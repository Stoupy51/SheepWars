...
#
# @within	sheepwars:v2.4.1/tick [ as @e[type=marker,tag=sheepwars.magic_wool] & at @s ]
#
...
execute as @n[type=arrow,nbt={inBlockState:{}},distance=..1.69] run function sheepwars:magic_wool/arrow
