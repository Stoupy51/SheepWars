...
#
# @executed	as @e[type=sheep,tag=sheepwars.new]
#
# @within	sheepwars:sheeps/final/fragmentation [ as @e[type=sheep,tag=sheepwars.new] ]
#			sheepwars:sheeps/summon/soutien [ as @e[tag=sheepwars.new] & at @s ]
