...
#> sheepwars:v2.3.4/load/enumerate
#
...
execute if score #sheepwars.major load.status matches 2 if score #sheepwars.minor load.status matches 3 unless score #sheepwars.patch load.status matches 4.. run scoreboard players set #sheepwars.patch load.status 4
